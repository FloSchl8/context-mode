...
This is a deliberate architectural choice, not a missing feature. Context optimization should happen at the source, not in a dashboard after the fact. And it should be free, open-source, and community-driven.
